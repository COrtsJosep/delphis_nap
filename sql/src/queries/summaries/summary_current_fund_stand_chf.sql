select
	...
	(accounts.initial_balance + fund_changes.value) 
		...
		* (case when currency_exchanges_to_chf.value is null then 1.0 else currency_exchanges_to_chf.value end) 
		as "current_value!"
from 
	accounts
	left join (
	...
	left join currency_exchanges as currency_exchanges_to_chf
	on
		currency_exchanges_to_chf.date = date('now')
		and currency_exchanges_to_chf.currency_to = 'CHF'
		and currency_exchanges_to_chf.currency_from = currency_exchanges_to_eur.currency_to	
